...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-04-16")
public class ThriftOrderService {

  public interface Iface {

    public void save(com.github.thrift.wrapper.domain.thrift.ThriftOrder order) throws org.apache.thrift.TException;

    public void saveAll(List<com.github.thrift.wrapper.domain.thrift.ThriftOrder> orders) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void save(com.github.thrift.wrapper.domain.thrift.ThriftOrder order, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void saveAll(List<com.github.thrift.wrapper.domain.thrift.ThriftOrder> orders, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_save(com.github.thrift.wrapper.domain.thrift.ThriftOrder order) throws org.apache.thrift.TException
    {
    ...
    public void send_saveAll(List<com.github.thrift.wrapper.domain.thrift.ThriftOrder> orders) throws org.apache.thrift.TException
    {
      saveAll_args args = new saveAll_args();
      args.setOrders(orders);
      sendBase("saveOrderList", args);
    }

    public void recv_saveAll() throws org.apache.thrift.TException
    {
      saveAll_result result = new saveAll_result();
      receiveBase(result, "saveOrderList");
      return;
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void save(com.github.thrift.wrapper.domain.thrift.ThriftOrder order, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      save_call method_call = new save_call(order, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class save_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public save_call(com.github.thrift.wrapper.domain.thrift.ThriftOrder order, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void saveAll(List<com.github.thrift.wrapper.domain.thrift.ThriftOrder> orders, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      saveAll_call method_call = new saveAll_call(orders, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class saveAll_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public saveAll_call(List<com.github.thrift.wrapper.domain.thrift.ThriftOrder> orders, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orders = orders;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("saveOrderList", org.apache.thrift.protocol.TMessageType.CALL, 0));
        saveAll_args args = new saveAll_args();
        args.setOrders(orders);
        args.write(prot);
        prot.writeMessageEnd();
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("saveOrderList", new saveAll());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class save<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, save_args, Void> {
      ...
      public void start(I iface, save_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.save(args.order,resultHandler);
      }
    }
    ...
    public static class saveAll<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, saveAll_args, Void> {
      ...
      public void start(I iface, saveAll_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.saveAll(args.orders,resultHandler);
      }
    }
